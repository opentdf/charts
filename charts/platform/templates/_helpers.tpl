...
{{- if and .Values.services.kas.preview.key_management (not (and .Values.services.kas.root_key_secret.name .Values.services.kas.root_key_secret.key)) }}
{{- fail "When services.kas.preview.key_management is true, you must set both services.kas.root_key_secret.name and services.kas.root_key_secret.key" }}
{{- end -}}
{{- end -}}
