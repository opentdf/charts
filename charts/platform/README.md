...
| server.grpc.maxCallRecvMsgSize | string | `nil` | This is the maximum size of a message that can be received by the server, ex. 4194304 (4MB). |
| server.grpc.maxCallSendMsgSize | string | `nil` | This is the maximum size of a message that can be sent by the server, ex. 4194304 (4MB).. |
